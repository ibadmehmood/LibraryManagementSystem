...
<div class="col-sm-6" >
<h4 style="color:white;background-color:#40bf40;padding:10px;"><span class="glyphicon glyphicon-plus"></span>&nbsp; Members | Add Members</h4>
</div>
</div>
...
$sqlk="select * from members where studentid='$studentid'";
...
$sql="insert into members(studentid,studentname,fathername,department,username,password) values('$studentid','$studentname','$fathername','$department','$studentid','$studentid')";
...
<input type="text" class="form-control" placeholder="Student ID" name="id" required>
</div>
<div class="form-group">
...
<input type="submit" class="btn btn-success" name="submit" style="background-color:#40bf40;" value="Add Member">
