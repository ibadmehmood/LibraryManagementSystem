...
<li class="active"><a href="bookmanager.php" ><span class="glyphicon glyphicon-list-alt"></span>&nbsp; Library Books Manager</a></li>
...
<div class="col-sm-6" >
<h4 style="color:white;background-color:#ffcc33;padding:10px;"><span class="glyphicon glyphicon-user"></span>&nbsp; Books | Get Started</h4>
</div>
</div>

<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Books</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="addbook.php"><button type="button" class="btn btn-primary" style="background-color:#40bf40;"><span class="glyphicon glyphicon-plus"></span>&nbsp; Proceed</button></a>
</div>
</div>
<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-search"></span>&nbsp;Search Books</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="searchbook.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span>&nbsp; Proceed</button></a>
</div>
</div>
<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete Books</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="deletebook.php"><button type="button" class="btn btn-primary" style="background-color:#ffcc33;"><span class="glyphicon glyphicon-lock"></span>&nbsp; Proceed</button></a>
</div>
</div>
