...
<div class="col-sm-6" >
<h4 style="color:white;background-color:#3399ff;padding:10px;"><span class="glyphicon glyphicon-random"></span>&nbsp; Book Transit | Get Started</h4>
</div>
</div>

<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-plus"></span>&nbsp; Issue Book</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="issuebook.php"><button type="button" class="btn btn-primary" style="background-color:#40bf40;"><span class="glyphicon glyphicon-plus"></span>&nbsp; Proceed</button></a>
</div>
</div>
<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-search"></span>&nbsp;Return Book</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="returnbook.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span>&nbsp; Proceed</button></a>
</div>
</div>
<div class="col-sm-4">
<div class="col-sm-12 mystyle">
<h4 class="page-header"><span class="glyphicon glyphicon-file"></span>&nbsp;Issued Books</h4>
<p>This Tab allows you to create operators to operate with the library data with a custom set privilage</p>
<a href="issuedbooks.php"><button type="button" class="btn btn-primary" style="background-color:#ffcc33;"><span class="glyphicon glyphicon-lock"></span>&nbsp; Proceed</button></a>
</div>
</div>
