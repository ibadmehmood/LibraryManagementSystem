...
<li class="active"><a href="editprofiles.php" ><span class="glyphicon glyphicon-list-alt"></span>&nbsp; Edit Profile</a></li>
...
$sql="select * from members where studentid='$usernames'";
...
<input type="text" class="form-control" placeholder="Student ID" name="id" value="<?php echo $id;?>" disabled>
</div>
<div class="form-group">
<label>Student Name</label>
<input type="text" class="form-control" placeholder="Student Name" name="studentname" value="<?php echo $name;?>" required>
...
<input type="text" class="form-control" placeholder="Father Name" name="fname"  value="<?php echo $f;?>"required>

</div>
<div class="form-group">
<label>Department</label>
<input type="text" class="form-control" placeholder="Department" name="department" value="<?php echo $d;?>" required>
</div>
</div>
<div class="col-sm-12">
<div class="form-group">
...
<input type="text" class="form-control" placeholder="password" name="password" value="<?php echo $p;?>" required>

</div>

</div>

<input type="submit" class="btn btn-success" name="submit" style="background-color:#40bf40;" value="Update">
