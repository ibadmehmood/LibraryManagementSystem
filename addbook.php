...
<div class="col-sm-6" >
<h4 style="color:white;background-color:#40bf40;padding:10px;"><span class="glyphicon glyphicon-plus"></span>&nbsp; Library | Add Book</h4>
</div>
</div>
...
$sqlk="select * from books where bookid='$bookid'";
...
$sql="insert into books(bookid,booktitle,bookauthor,bookisbn) values('$bookid','$booktitle','$bookauthor','$bookisbn')";
...
<input  type="submit" name="submit" class="btn btn-success" style="background-color:#40bf40;" value="Add Book"> 
