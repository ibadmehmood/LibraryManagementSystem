...
<div class="col-sm-6" >
<h4 style="color:white;background-color:#40bf40;padding:10px;"><span class="glyphicon glyphicon-plus"></span>&nbsp; Book Transit | Return Book</h4>
</div>
</div>
...
$sql="delete  from books_members where bookid='$bookid' AND studentid='$studentid'";

if($conn->query($sql)===true){
	
	echo "<div class='alert alert-success'><a href='' class='close' data-dismiss='alert'>&times;</a><strong>Success!</strong> Book has been Returned !</div>";
...
echo "<div class='alert alert-warning'><a href='' class='close' data-dismiss='alert'>&times;</a><strong>Failure!</strong> Record Doest not Exits!</div>";
}
...
$sql="insert into books_returned(bookid,studentid,return_date) values('$bookid','$studentid','$currentdate')";

if($conn->query($sql)===true){
	
	header("location:generate.php?studentid=$studentid&bookid=$bookid");
...
<input type="submit" name="submit" class="btn btn-success" style="background-color:#40bf40;" value="Generate Invoice">
<input type="submit" name="return" class="btn btn-warning" style="background-color:#ffcc33;" value="Return Book"> 
</form>
